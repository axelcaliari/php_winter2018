                ...
                <thead>
                  ...
                  {foreach from=$view.results item=product}
                    <tr>
                        ...
                        <td>{html_image file="http://localhost/lightmvctest/public/img/"|cat:$product.image}</td>
                        <td>
                            <a href="/lightmvctest/public/index.php/product/edit/?id={$product.id}">Modify</a>
                        </td>
                        <td>
                            <a href="/lightmvctest/public/index.php/product/delete/?id={$product.id}|name={$product.image}">Delete</a>
                        </td>
                    </tr>
                  {/foreach}
              </table>
