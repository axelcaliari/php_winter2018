...
<div class="row">
  ...
  <div class="col-sm-4 jumbotron text-center">
    <h3 class="text-center"><a href="http://localhost/lightmvctest/public/index.php/product/index?id={$product.id}">{$product.name}</a></h3><br> 
    <img src="{$product.picture}" alt="Smiley face" height="200" width="200"><br><br>
    <b>Description:</b> {$product.description}<br>
    <b>Price:</b> {$product.price}<br><br>
    {if isset($smarty.session.user)} 
      <a href="http://localhost/lightmvctest/public/index.php/product/update?id={$product.id}" class="btn btn-primary" role="button">Update</a><br><br>
